## API Report File for "alchemy-sdk"
...
// @public
export function refreshNftMetadata(alchemy: Alchemy, nft: BaseNft): Promise<boolean>;

// @public
export function refreshNftMetadata(alchemy: Alchemy, contractAddress: string, tokenId: BigNumberish): Promise<boolean>;
