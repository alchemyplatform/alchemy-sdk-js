...
IMPORTANT NOTE: Please install the beta package and refer to the upcoming [v1.2.0 branch](https://github.com/alchemyplatform/alchemy-sdk-js/pull/40) for the latest syntax. This will be pushed to production on 7/25. 
