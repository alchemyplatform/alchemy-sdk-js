...
export class AlchemyWebSocketProvider {
  ...
  sendBatch(
    ...
    callback: (error: Error | null, response?: SingleOrBatchResponse[]) => void
  ): void {}
  ...
  //     const connection = AlchemyProvider.getAlchemyFetchRequest(
  //       alchemyNetwork,
  //       apiKey,
  //       'wss'
  //     );
